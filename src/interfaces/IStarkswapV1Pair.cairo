...
trait IStarkswapV1Pair {
    ...
    fn  getObservations(num_observations: felt252) -> (
        felt252, Array<Observation>
    );
    ...
    fn  swap(
        base_out: u256, quote_out: u256, to: felt252, calldata_len: felt252, calldata: Array<felt252>
    );
