...
func make_18_dec{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(value: Uint256, decimals: felt) -> (value_18_dec: Uint256):
    alloc_locals
    if decimals == 18:
        return (value)
    else:
...
func unmake_18_dec{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(value: Uint256, decimals: felt) -> (value: Uint256):
    alloc_locals
    if decimals == 18:
        return (value)
    else:
