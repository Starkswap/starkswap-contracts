...
// @author Mesh Finance
// @license MIT
// @notice Upgradeable proxy for StarkswapV1Pair.cairo
...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    implementation_hash: felt, token0: felt, token1: felt, curve_class_hash: felt, proxy_admin: felt
) {
    ...
    assert [calldata + 2] = curve_class_hash;
