...
mod StarkswapV1Pair {
    ...
    impl StarkSwapV1PairImpl of starkswap_contracts::interfaces::IStarkswapV1Pair::IStarkswapV1Pair<ContractState> {
        ...
        fn mint(ref self: ContractState, to: ContractAddress) -> u256 {
            ...
            let fee_on = _mint_fee(ref self, base_token_reserve, quote_token_reserve);
            ...
            _update(ref self, base_token_balance, quote_token_balance, base_token_reserve, quote_token_reserve);

            if (fee_on == true) {
                _update_k_last(ref self, base_token_balance, quote_token_balance);
                _unlock(ref self);
                return liquidity;
            }
        ...
        fn swap(
            ...
            _transfer_out(
                ref self, base_token_address, quote_token_address, base_amount_out, quote_amount_out, to
            );
            _invoke_callee(@self, base_amount_out, quote_amount_out, to, calldata);
            ...
            _update(ref self, base_token_balance, quote_token_balance, base_amount_out, quote_amount_out);
            let sender = get_caller_address();
